...
public class UnknownGender extends AppCompatActivity implements AdapterView.OnItemClickListener {
    private static final String TAG = "UnknownGender";
    ...
    private void initView() {
        gridView = (GridView) findViewById(R.id.grid_unknowng);
    ...
    public void onItemClick(final AdapterView<?> arg0, final View view, final int position, final long id)
    {
        ...
        startActivity(new Intent(UnknownGender.this, CharacterCalled.class).putExtra("CHAR_ID", charID));
    }
    ...
    void startAPICall(int page) {
        try {
            JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(
                    Request.Method.GET,
                    "https://rickandmortyapi.com/api/character/?page=" + Integer.toString(page) + "&gender=unknown",
                    null,
